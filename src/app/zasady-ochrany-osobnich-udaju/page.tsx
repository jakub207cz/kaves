...
// Document title and meta description will be handled by a layout component or in index.html
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        ...
        <section className="mb-8">
          ...
          <p className="mt-8 text-muted-foreground">
            Děkujeme, že jste si přečetli naše zásady ochrany osobních údajů.
          </p>
